...
public class ProtocolClient implements Runnable {
	...
	public void setProtocolMsg(byte msgType, String jsonString) {
		...
		protocolHeader.setIsList((short) 0);
	...
	public static void main(String[] args) {
		//String condition="{policeNo:'051087',loginCondtion:{pass:'051087',imei:'',imsi:'',iccid:''}}";
		//String msgType="LOGIN";
		String condition="{fdjh:'683D14935'}";
		int isList = 1;
